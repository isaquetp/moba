...
#ifeq (moba,$(findstring moba,$(TARGET_DEVICE)))
#$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/tfa9894/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/aw88264/Module.symvers)
#endif
...
include $(MY_LOCAL_PATH)/asoc/codecs/aw88264/Android.mk
#endif
endif
