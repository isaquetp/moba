...
void BatteryMonitor::init(struct healthd_config *hc) {
    ...
    if (dir == NULL) {
        ...
        while ((entry = readdir(dir.get()))) {
			...
			!strcmp(name, "dc") || \
			!strcmp(name, "main") || \
			!strcmp(name, "bq2597x-master") || \
			!strcmp(name, "bq2597x-slave") || \
			!strcmp(name, "bq2597x-sec-master") || \
			!strcmp(name, "bq2597x-sec-slave") || \
			!strcmp(name, "bq27z561-slave") || \
			!strcmp(name, "bq27z561-master"))
                continue;
            ...
            KLOG_WARNING(LOG_TAG, "get path '%s'\n", name);
